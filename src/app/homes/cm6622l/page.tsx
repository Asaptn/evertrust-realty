...
export default function CM6622LDetails() {
  const images = ["/images/cm6622l/cm6622-1.jpg", "/images/cm6622l/cm6622-2.jpg", "/images/cm6622l/cm6622-3.jpg", "/images/cm6622l/cm6622-4.jpg", "/images/cm6622l/cm6622-5.jpg", "/images/cm6622l/cm6622-6.jpg", "/images/cm6622l/cm6622-7.jpg", "/images/cm6622l/cm6622-8.jpg", "/images/cm6622l/cm6622-9.jpg"];
  ...
  return (
    <main className="bg-red-100 min-h-screen pt-28 pb-12 px-4 md:px-8 text-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Mobile Home for Sale – CM6622L</h1>
          <p className="text-xl text-green-600 font-semibold mt-2">$70,000</p>
        </div>
        <div className="relative group mb-6 overflow-hidden rounded-2xl shadow-2xl bg-gray-100">
          <img src={images[activeIndex]} alt="CM6622L" className="w-full h-[350px] md:h-[600px] object-cover" />
        ...
        <div className="bg-gray-50 p-6 md:p-10 rounded-3xl border border-gray-100">
          ...
          <p className="text-gray-700 text-lg mb-6">Affordable 2-bedroom, 2-bathroom home. Perfect for small families.</p>
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <a href="sms:+13022301063?body=Hi! I am interested in the 2-bedroom CM6622L for $70,000." className="bg-blue-600 text-white py-4 rounded-xl font-bold text-lg text-center shadow-lg hover:bg-blue-700">Send Text Message</a>
          </div>
        </div>
      </div>
    </main>
